...
AZURE_CHAT_DEPLOYMENT_TEXT = os.getenv("AZURE_OPENAI_CHAT_DEPLOYMENT")  # kept for completeness
AZURE_TTS_DEPLOYMENT = os.getenv("AZURE_OPENAI_TTS_DEPLOYMENT")         # kept for completeness

if not AZURE_OPENAI_ENDPOINT:
    logger.warning("AZURE_OPENAI_ENDPOINT is not set. OpenAI client may fail to initialize.")
